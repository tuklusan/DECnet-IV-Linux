...
#define DNIV_NSP_REASON_NO_RESOURCES 1U
#define DNIV_NSP_REASON_OBJECT_FAILED 38U
#define DNIV_NSP_REASON_NODE_UNREACHABLE 39U
#define DNIV_NSP_REASON_NO_LINK 41U
#define DNIV_NSP_REASON_DISCONNECT_COMPLETE 42U
...
static inline int
dniv_nsp_duplicate_ci_reack_allowed(enum dniv_nsp_conn_state state)
{
