...
Phase 5 is active. Start NSP with packet codecs/state-machine primitives and timers, then implement kernel NSP connection state, sequencing, retransmission, flow control and native socket/UAPI integration. Do not reopen Phase 4 without concrete regression evidence.
