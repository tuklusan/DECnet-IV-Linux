...
4. Perform substantive work on a feature branch from the exact current `main` commit. Promote only the exact commit that has passed the required SoP and acceptance gates; do not amend or rebuild between green evidence and promotion.
